<%-- 
    Document   : ResultAddService
    Created on : Nov 8, 2025, 7:11:36 PM
    Author     : TR_NGHIA
--%>
...
<html lang="vi">
    <head>
        ...
        <title>Kết quả Thêm Dịch vụ</title>
    ...
    <body>
        <%
            Boolean addSuccess = (Boolean) request.getAttribute("ADD_SUCCESS");
            String successMessage = (String) request.getAttribute("SUCCESS_MESSAGE");
            String errorMessage = (String) request.getAttribute("ERROR_MESSAGE");
            Service newService = (Service) request.getAttribute("SERVICE_NEW");
                ...
                <div class="col-lg-8">
                    ...
                    <nav aria-label="breadcrumb" class="mb-3">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Kết quả thêm mới</li>
                        </ol>
                    </nav>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <h3 class="text-success mb-3">Thêm dịch vụ thành công!</h3>
                            <p class="text-muted mb-4">
                                <%= successMessage != null ? successMessage : "Dịch vụ mới đã được thêm vào hệ thống."%>
                            </p>
                            ...
                            %>
                            <!-- Service Information -->
                            <div class="service-info text-start mb-4">
                                <h5 class="mb-3"><i class="bi bi-info-circle me-2"></i>Thông tin dịch vụ vừa thêm:</h5>
                                
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <span class="service-info-label">Mã dịch vụ:</span>
                                    </div>
                                    <div class="col-md-8">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <span class="service-info-label">Tên dịch vụ:</span>
                                    </div>
                                    <div class="col-md-8">
                                        <span class="service-info-value"><strong><%= newService.getServiceName()%></strong></span>
                                    </div>
                                </div>
                                
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <span class="service-info-label">Loại dịch vụ:</span>
                                    </div>
                                    <div class="col-md-8">
                                        <span class="badge bg-info text-dark"><%= newService.getServiceType()%></span>
                                    </div>
                                </div>
                                
                                <div class="row">
                                    <div class="col-md-4">
                                        <span class="service-info-label">Giá dịch vụ:</span>
                                    </div>
                                    <div class="col-md-8">
                                        <span class="service-info-value">
                                            <strong style="color: #2e7d32; font-size: 1.1rem;">
                                                <%= String.format("%,.0f", newService.getPrice())%> VNĐ
                                            </strong>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                <a href="<%= IConstant.ACTION_VIEW_EDIT_SERVICE%>" class="btn btn-primary-custom">
                                    <i class="bi bi-arrow-left me-1"></i> Quay lại danh sách
                                </a>
                                <a href="<%= IConstant.ACTION_ADD_SERVICE%>" class="btn btn-outline-secondary">
                                    <i class="bi bi-plus-circle me-1"></i> Thêm dịch vụ khác
                                </a>
                            </div>
                            ...
                            <h3 class="text-danger mb-3">Thêm dịch vụ thất bại!</h3>
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                <a href="<%= IConstant.ACTION_VIEW_EDIT_SERVICE%>" class="btn btn-secondary">
                                    <i class="bi bi-arrow-left me-1"></i> Quay lại danh sách
                                </a>
        ...
        <%
            // Auto redirect after 10 seconds if success
            if (addSuccess != null && addSuccess) {
        %>
        <script>
            setTimeout(function() {
                window.location.href = '<%= IConstant.ACTION_VIEW_EDIT_SERVICE%>';
            }, 10000);
        </script>
        <%
            }
