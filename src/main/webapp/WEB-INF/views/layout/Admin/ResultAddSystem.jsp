...
<%--
    Document   : ResultAddSystem
    Created on : Nov 3, 2025, 2:14:33 PM
    Author     : TR_NGHIA
--%>
...
<html lang="vi">
    <head>
        ...
        <title>Kết quả Thêm Cấu hình</title>
    ...
    <body>
        <%
            ...
            SystemConfig newConfig = (SystemConfig) request.getAttribute("CONFIG_NEW");
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <h3 class="text-success mb-3">Thêm cấu hình thành công!</h3>
                            <p class="text-muted mb-4">
                                <%= successMessage != null ? successMessage : "Cấu hình mới đã được thêm vào hệ thống."%>
                            </p>
                            ...
                            <div class="config-info text-start mb-4">
                                <h5 class="mb-3"><i class="bi bi-info-circle me-2"></i>Thông tin cấu hình vừa thêm:</h5>
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <span class="config-info-label">Tên cấu hình:</span>
                                    </div>
                                    <div class="col-md-8">
                                        <span class="config-info-value"><strong><%= newConfig.getConfigName()%></strong></span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        <span class="config-info-label">Giá trị:</span>
                                    </div>
                                    <div class="col-md-8">
                                        <span class="config-info-value">
                                            <code style="background-color: #e9ecef; padding: 0.25rem 0.5rem; border-radius: 4px;">
                                                <%= newConfig.getConfigValue()%>
                                            </code>
                                        </span>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <%
                                            String statusBadge = newConfig.isStatus() ? "badge bg-success" : "badge bg-secondary";
                                            String statusText = newConfig.isStatus() ? "Đang áp dụng" : "Không áp dụng";
                                        %>
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                ...
                                <a href="<%= IConstant.ACTION_ADD_SYSTEM%>" class="btn btn-outline-secondary">
                                    <i class="bi bi-plus-circle me-1"></i> Thêm cấu hình khác
                                </a>
                            </div>
                            ...
                            <h3 class="text-danger mb-3">Thêm cấu hình thất bại!</h3>
