<%--
    ...
    Created on : Oct 31, 2025, 10:00:00 PM
    Author     : TR_NGHIA
--%>
...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            /* Style cho menu dọc (list) - Đã có padding */
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="mainNavbar">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="<%= IConstant.ACTION_VIEW_EDIT_SYSTEM%>"><i class="bi bi-gear-fill me-1"></i> Cấu hình hệ thống</a>
                        </li>
                    </ul>
                ...
                <div class="col-lg-3">
                    <div class="card sidebar-menu p-0">
                        <div class="list-group list-group-flush">
                            <a href="<%= IConstant.ACTION_MANAGER_ROOMS%>" class="list-group-item list-group-item-action active" aria-current="true">
                ...
                <div class="col-lg-9">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="#" class="btn btn-sm btn-add-staff">
                        ...
                        <div class="card-body">
                            ...
                            <%
                                ArrayList<Room> rooms = (ArrayList<Room>) request.getAttribute("ROOM_LIST");
                                Map<Integer, RoomType> roomTypeMap = (Map<Integer, RoomType>) request.getAttribute("ROOM_TYPE_LIST");
                                ...
                                <table class="table table-hover align-middle">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th scope="col">Sức chứa (Người)</th>
                                    ...
                                    <tbody>
                                        <%
                                            for (Room room : rooms) {
                                                ...
                                                int capacity = (roomType != null) ? roomType.getCapacity() : 0;
                                                String pricePerDay = (roomType != null && roomType.getPricePerNight()!= null)
                                                        ? currencyFormat.format(roomType.getPricePerNight())
                                                        : "N/A";

                                                // Xác định class và text cho status
                                                String statusClass = "";
                                                String statusText = "";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="btn btn-sm btn-outline-danger" title="Xóa" 
                                                   onclick="return confirm('Bạn có chắc chắn muốn xóa phòng <%= room.getRoomNumber()%>?')">
