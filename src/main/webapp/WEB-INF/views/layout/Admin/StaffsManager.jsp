...
<%--
    Document   : StaffsManager
    Created on : Oct 31, 2025, 9:30:55 PM
    Author     : TR_NGHIA
--%>
...
<%
    ...
    // Lấy 2 list từ request
    ArrayList<Staff> searchList = (ArrayList<Staff>) request.getAttribute("STAFF_SEARCH_LIST");
    ArrayList<Staff> allList = (ArrayList<Staff>) request.getAttribute("STAFF_LIST");

    // Ưu tiên hiển thị searchList, nếu null hoặc empty thì dùng allList
    ArrayList<Staff> displayList = (searchList != null && !searchList.isEmpty()) ? searchList : allList;

    // Lấy giá trị search để giữ lại trong form
    String searchValue = (String) request.getAttribute("SEARCH_VALUE");
    String searchStatus = (String) request.getAttribute("SEARCH_STATUS");
...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            /* Style cho menu dọc (list) - Đã chỉnh sang màu xanh */
                ...
                <div class="col-lg-3">
                    <div class="card sidebar-menu p-0">
                        <div class="list-group list-group-flush">
                            <a href="<%= IConstant.ACTION_MANAGER_STAFFS%>" class="list-group-item list-group-item-action active" aria-current="true">
                                <i class="bi bi-list-task me-2"></i>
                                Quản lý nhân viên
                            </a>
                            <a href="<%= IConstant.ACTION_EDIT_STAFFS%>" class="list-group-item list-group-item-action">
                ...
                <div class="col-lg-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<%= IConstant.ACTION_SEARCH_STAFFS%>" method="POST">
                                <div class="row g-3 mb-3">
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="searchTxt" 
                                               value="<%= searchValue%>"
                                               placeholder="Tìm kiếm nhân viên (theo tên, SĐT, email...)">
                                    </div>
                                    <div class="col-md-3">
                                        <select class="form-select" name="searchStatus">
                                            <option value="all" <%= "all".equals(searchStatus) ? "selected" : ""%>>Tất cả trạng thái</option>
                                            <option value="1" <%= "1".equals(searchStatus) ? "selected" : ""%>>Đang làm việc</option>
                                            <option value="0" <%= "0".equals(searchStatus) ? "selected" : ""%>>Đã nghỉ</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
